...
# Shengnan Zhou
# ---------------------------------------
# A program will move the blank space
# according to user's input.
#
# (Note: Don't purposely input something
# wrong continuously, it might break the
# program.)
# ---------------------------------------
...
# ---------------------------------------
    ...
    def is_puzzle_solved(self):
        """Check if the result matches the solution"""
    ...
    def move_blank(self):
        ...
        move = move.lower()
        if move == "up":
            while self.blank_x == 0:
                print("That move is invalid.  Please try again.")
                self.move_blank()

            self.swap_positions(self.blank_x, self.blank_y, self.blank_x - 1, self.blank_y)
            self.blank_x = self.blank_x - 1



        elif move == "down":
            while self.blank_x == 2:
                print("That move is invalid.  Please try again.")
                self.move_blank()
            ...
            while self.blank_y == 0:
                print("That move is invalid.  Please try again.")
                self.move_blank()

            self.swap_positions(self.blank_x, self.blank_y, self.blank_x, self.blank_y - 1)
            self.blank_y = self.blank_y - 1



        elif move == "right":
            while self.blank_y == 2:
                print("That move is invalid.  Please try again.")
                self.move_blank()
